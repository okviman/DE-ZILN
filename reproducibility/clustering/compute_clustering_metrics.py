        ...
        for key in resolution_keys:
            ...
            for cluster in clusters:
                cluster_signatures[method][key][cluster] = get_top_sig_genes_adata(
                    adata, cluster, top_genes=top_genes, key=method_key, pval_threshold=0.05
                )
        ...
        for key in resolution_keys:
            ...
            for i, clus in enumerate(clusters):
                ...
                for j, ct in enumerate(cell_types):
                    mat[i, j] = jaccard_index(sig_genes, cell_type_signatures[ct])
        ...
        for key in resolution_keys:
            ...
            for ct in cell_types:
                ...
                for clus in clusters:
                    sig_genes = cluster_signatures[method][key][clus]
                    jacc = jaccard_index(sig_genes, s)
